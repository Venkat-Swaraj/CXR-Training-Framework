...
namespace ImmersiveVRTools.Editor.Common.WelcomeScreen
{
    ...
    {
        protected static void HandleUnityStartup(Action openWindow, string getUpdatesUrl, 
            List<ProjectEditorPreferenceDefinitionBase> preferencesToInitialize, AdditionalOnWindowOpened additionalOnWindowOpen = null)
        {
