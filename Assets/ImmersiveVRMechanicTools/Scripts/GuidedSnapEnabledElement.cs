...
public abstract class GuidedSnapEnabledElement : MonoBehaviour
{
    ...
    [SerializeField] [ReadOnly] private XRFrameworkTransformControl _xrFrameworkTransformControl;
    ...
    public XRFrameworkTransformControl XRFrameworkTransformControl => _xrFrameworkTransformControl ??= GetComponent<XRFrameworkTransformControl>();
    ...
    protected virtual void Start()
    {
        ...
        if (!_xrFrameworkTransformControl) _xrFrameworkTransformControl = GetComponent<XRFrameworkTransformControl>();
